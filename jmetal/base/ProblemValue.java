 ...
 */
public abstract class ProblemValue<T extends VariableValue> extends Problem<T> {

  private static final long serialVersionUID = -8566135748731031117L;
  ...
  public String getName() {
	...
	public static abstract class ProblemBinary extends ProblemValue<Binary> {
	...
	public static abstract class ProblemInt extends ProblemValue<Int> {
	...
	public static abstract class ProblemReal extends ProblemValue<Real> {
	...
	public static abstract class ProblemPermutation extends ProblemValue<Permutation> {
	...
	public static abstract class ProblemBinaryReal extends ProblemValue<BinaryReal> {
