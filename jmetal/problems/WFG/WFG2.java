 ...
 */
public class WFG2<V extends IReal> extends WFG<V> {
    
 private static final long serialVersionUID = -8675020339763314113L;
...
/**
  ...
  */
  public WFG2(Class<V> solutionType) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public WFG2(Integer k, Integer l, Integer M,Class<V> solutionType) {
