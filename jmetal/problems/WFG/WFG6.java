 ...
 */
public class WFG6<V extends IReal> extends WFG<V> {
    
 private static final long serialVersionUID = 6207115265526269632L;
...
/**
  ...
  */
  public WFG6(Class<V> solutionType) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public WFG6(Integer k, Integer l, Integer M,Class<V> solutionType) {
