...
/** 
* Class representing problem ZZJ07_F6
*/
public class ZZJ07_F6<V extends IReal>  extends ProblemValue<V> {
  
 private static final long serialVersionUID = -4661660615529851364L;

 private final Class<V> solutionType_;

/** 
  * Constructor
  * Creates a default instance of the ZZJ07_F6 problem
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
 public ZZJ07_F6(Class<V> solutionType) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
 public ZZJ07_F6(Integer numberOfVariables, Class<V> solutionType) {
   numberOfVariables_   = numberOfVariables.intValue() ;
   numberOfObjectives_  = 2;
   numberOfConstraints_ = 0;
   problemName_         = "ZZJ07_F6";
