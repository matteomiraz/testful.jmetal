...
/** 
* Class representing problem ZZJ07_F7
*/
public class ZZJ07_F7<V extends IReal>  extends ProblemValue<V> {
  
 private static final long serialVersionUID = 4286198795105692644L;

 private final Class<V> solutionType_;

/** 
  * Constructor
  * Creates a default instance of the ZZJ07_F7 problem
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
 public ZZJ07_F7(Class<V> solutionType) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
 public ZZJ07_F7(Integer numberOfVariables, Class<V> solutionType) {
   numberOfVariables_   = numberOfVariables.intValue() ;
   numberOfObjectives_  = 2;
   numberOfConstraints_ = 0;
   problemName_         = "ZZJ07_F7";
