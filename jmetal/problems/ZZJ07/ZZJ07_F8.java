 ...
 */
public class ZZJ07_F8<V extends IReal>  extends ProblemValue<V> {
   ...
   */
  public ZZJ07_F8(Class<V> solutionType) {
   ...
   * @param solutionType The solution type must "Real" or "BinaryReal".
   */
  public ZZJ07_F8(Integer numberOfVariables, Class<V> solutionType) {
